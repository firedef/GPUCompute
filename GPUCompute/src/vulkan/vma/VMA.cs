...
namespace GPUCompute.vulkan.vma;

public static class Vma {
    private const string _libraryName = "VulkanMemoryAllocator";
    ...
    public struct VmaStats {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = vkMaxMemoryTypes)]
        public VmaStatInfo[] memoryType;

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = vkMaxMemoryHeaps)]
    ...
    public struct VmaDefragmentationInfo2 {
        private VmaDefragmentationFlags _flags;
        private uint _allocationCount;
        private IntPtr _pAllocations;
        private IntPtr _pAllocationsChanged;
        private uint _poolCount;
        private IntPtr _pPools;
        private ulong _maxCpuBytesToMove;
        private uint _maxCpuAllocationsToMove;
        private ulong _maxGpuBytesToMove;
        private uint _maxGpuAllocationsToMove;
    ...
    public struct VmaDefragmentationStats {
        ...
        private ulong _bytesFreed;
        private uint _allocationsMoved;
        private uint _deviceMemoryBlocksFreed;
    }
     ...
     */
    public delegate void PfnVmaAllocateDeviceMemoryFunction(
        IntPtr allocator,
        uint memoryType,
        ulong memory,
        ulong size
     ...
     * size is a VkDeviceSize
     */
    public delegate void PfnVmaFreeDeviceMemoryFunction(
        IntPtr allocator,
        uint memoryType,
        ulong memory,
        ulong size
